...
We use GitHub issues to track public bugs. Report a bug by [opening a new issue](https://github.com/jsleb333/python2latex/issue). You should use one of our [proposed templates](https://github.com/jsleb333/python2latex/tree/master/.github/ISSUE_TEMPLATE) when appropriate; they are integrated with GitHub and do most of the formatting for you. It's that easy!
...
* Do a [quick search](https://github.com/jsleb333/python2latex/issue) to see whether your enhancement has already been suggested.
...
All of the code is formatted using [yapf](https://github.com/google/yapf) with the associated [config file](https://github.com/jsleb333/python2latex/blob/master/.style.yapf). In order to format the code of your submission, simply run
> We use the yapf version 0.27
```
yapf python2latex --recursive --in-place
yapf tests --recursive --in-place
```

We also have our own `pylint` [config file](https://github.com/jsleb333/python2latex/blob/master/.pylintrc). Try not to introduce code incoherences detected by the linting. You can run the linting procedure with
